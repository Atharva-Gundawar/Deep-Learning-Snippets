...
keras.utils.plot_model(ensemble_model, "ensemble_model.png") # Include 'show_shapes=True' as a parameter to display th shapes of the respective layers.
cv2.imshow("ensemble_model.png")